...
public class TestSuite {
  ...
  public static final String EVENT_PAYLOAD_MALFORMED_JSON =
      "src/test/resources/cim-event_payload_error.json";

  public static final String EVENT_PAYLOAD_ERROR_META_JSON =
      "src/test/resources/cim-event_payload_error_meta.json";

  public static final TupleTag<KV<String, String>> FAILURE_TAG =
      new TupleTag<KV<String, String>>() {};

  public static final TupleTag<KV<String, String>> SUCCESS_TAG =
      new TupleTag<KV<String, String>>() {};
